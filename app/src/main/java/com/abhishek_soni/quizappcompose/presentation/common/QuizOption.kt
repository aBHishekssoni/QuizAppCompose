...
import com.abhishek_soni.quizappcompose.presentation.util.Dimens.SmallCircleShape
...
@Composable
fun QuizOption(modifier: Modifier = Modifier,
               optionNumber: String,
               options: String,
               selected: Boolean,
               onOptionClick: () -> Unit,
    ...
    val startColor by transition.animateColor(transitionSpec ={tween(durationMillis = DefaultDurationMillis,easing = LinearEasing)},
    ...
    Box (
        ...
        Row(
            ...
            Spacer(modifier = Modifier
                .width(SmallSpaceHeight)
                .weight(0.6f))
            Text(modifier = Modifier.weight(7.1f),
                text = options,
                fontWeight = FontWeight.Bold,
                fontSize = 16.sp,
                maxLines = 3,
            ...
            if (selected){
                Box(
                    ...
                    IconButton(onClick = {onUnselectOption()}) {
                        Icon(painterResource(id = R.drawable.close), contentDescription = "close",tint = colorResource(id = R.color.orange))
                    }
                }
            }
            else{
